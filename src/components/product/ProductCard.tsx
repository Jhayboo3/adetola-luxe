  ...
  return (
    <article className="group flex h-full min-w-0 flex-col">
      <Link href={href} className="block no-underline">
        ...
        {product.images?.[0] ? (
          <Image src={product.images[0]} alt={product.name} fill sizes="(max-width: 767px) 70vw, (max-width: 1279px) 33vw, 25vw" className="object-cover transition-transform duration-500 group-hover:scale-[1.03]" unoptimized />
