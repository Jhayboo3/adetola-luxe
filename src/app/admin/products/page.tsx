  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between gap-4">
        ...
        <Link href="/admin/products/new" className="bg-gold px-6 py-3 font-body text-[13px] font-semibold uppercase tracking-[1px] text-black no-underline">Add Clothing</Link>
      </div>
      {products.length === 0 ? (
        ...
        <div className="overflow-x-auto border border-line"><table className="w-full text-left"><thead><tr className="border-b border-line bg-black/5">
